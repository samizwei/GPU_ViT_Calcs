...
p_opt = {
    'learning_rate' : 1e-3,
    # 'learning_rate' : linear_schedule(init_value=0.5 * 1e-2, end_value = 0.5 * 1e-4, transition_begin=0, transition_steps=200),
...
with open('/scratch/samiz/GPU_ViT_Calcs/XYZ_8x8_Lattice_ViT/patching_xy44/Log_Files/log_vit_sampler_HaEx_5050_trans.pickle', 'rb') as f:
    ps = pickle.load(f)
