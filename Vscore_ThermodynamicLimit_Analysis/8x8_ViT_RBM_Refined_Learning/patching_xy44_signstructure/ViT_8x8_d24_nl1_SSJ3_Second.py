...
p_opt = {
    # 'learning_rate' : 1e-2,
    'learning_rate' : linear_schedule(init_value=0.5 * 1e-2, end_value = 0.5 * 1e-5, transition_begin=100, transition_steps=200),
    # 'learning_rate': cosine_decay_schedule(init_value=1e-3, decay_steps = 100, alpha = 1e-2),
    # 'diag_shift': 1e-4,
    'diag_shift': linear_schedule(init_value=1e-3, end_value=1e-6, transition_begin=100, transition_steps=200),
    'n_samples': 2**12,
    'chunk_size': 2**12,
    'n_iter': 300,
}
...
DataDir = '/scratch/samiz/GPU_ViT_Calcs/XYZ_8x8_Lattice_ViT/patching_xy44_signstructure/Log_Files_J3/'
...
with open('/scratch/samiz/GPU_ViT_Calcs/XYZ_8x8_Lattice_ViT/patching_xy44_signstructure/Log_Files_J3/log_vit_sampler_HaEx_5050.pickle', 'rb') as f:
    ps = pickle.load(f)
