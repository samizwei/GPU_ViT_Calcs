...
class PickledJsonLog(RuntimeLog):
    """
    ...
    def __init__(
        ...
        self._files_open = [output_prefix + ".log", output_prefix + ".pickle"]
    ...
    def _flush_params(self, variational_state):
        ...
        # )
        if self._is_master_process:
            with open(self._prefix + ".pickle", "wb") as outfile:
                pickle.dump(variational_state.variables, outfile)
