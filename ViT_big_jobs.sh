...
# python /scratch/samiz/GPU_ViT_Calcs/XYZ_8x8_Lattice_ViT/patching_xy44_signstructure/ViT_8x8_d24_nl1_SSJ2_Diff_First.py
...
#### how to run:  chmod +x my_script.sh ->    ./my_script.sh