...
p_opt = {
    ...
    'learning_rate' : linear_schedule(init_value=2*1e-2, end_value=1e-3, transition_begin=100, transition_steps=100),
    ...
    # 'diag_shift': 1e-4,
    'diag_shift': linear_schedule(init_value=1e-3, end_value=1e-4, transition_begin=150, transition_steps=50),
    'n_samples': 2**12,
    'chunk_size': 2**12,
    'n_iter': 200,
}
