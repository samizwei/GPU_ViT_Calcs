...
p_opt = {
    ...
    # 'diag_shift': 1e-4,
    'diag_shift': linear_schedule(init_value=1e-4, end_value=1e-5, transition_begin=200, transition_steps=300),
    'n_samples': 2**12,
    'chunk_size': 2**12,
    'n_iter': 500,
}
...
# '/scratch/samiz/GPU_ViT_Calcs/XYZ_8x8_Lattice_ViT/patching_xy44_signstructure/Log_Files_J2_Diff/'
