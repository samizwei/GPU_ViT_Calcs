...
path_to_store = 'RBM_alphas_5050HaEx/'
...
for alpha in alphas:
    ...
    StateLogger = PickledJsonLog(output_prefix=path_to_store + 'log_HaEx5050_rbm_alpha{}'.format(alpha), save_params_every=10, save_params=True)
