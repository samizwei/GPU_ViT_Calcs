...
Dir_store = 'ViT_d24_nl1_MultipleRules_XavierInit_SmoothSVD/'
...
#                 # define the model
    ...
    StateLogger = PickledJsonLog(output_prefix=Dir_store + 'log_vit_sampler_{}_smoothsvd'.format(sa_key), save_params_every=10, save_params=True)
    ...
    log_curr.serialize(Dir_store + 'log_vit_sampler_{}_smoothsvd'.format(sa_key)) 
