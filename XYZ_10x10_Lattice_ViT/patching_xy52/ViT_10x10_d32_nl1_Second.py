...
p_opt = {
    ...
    'learning_rate' : linear_schedule(init_value=1e-4, end_value = 1e-5, transition_begin=0, transition_steps=200),
...
with open('/scratch/samiz/GPU_ViT_Calcs/XYZ_10x10_Lattice_ViT/patching_xy52/Log_Files/log_vit_sampler_HaEx_5050.pickle', 'rb') as f:
    ps = pickle.load(f)
