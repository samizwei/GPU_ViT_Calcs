...
E0 = nk.exact.lanczos_ed(Ha16, k=1, compute_eigenvectors=False)
print('exact result: ', E0)
...
#                 # define the model
    ...
    StateLogger = PickledJsonLog(output_prefix=DataDir + 'log_vit_sampler_{}_sign'.format(sa_key), save_params_every=10, save_params=True)
