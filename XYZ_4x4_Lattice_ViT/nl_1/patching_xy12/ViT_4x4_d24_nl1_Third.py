...
with open(DataDir + 'log_vit_sampler_HaEx_5050_refined.pickle', 'rb') as f:
...
#     StateLogger = PickledJsonLog(output_prefix=DataDir + 'log_vit_sampler_{}_refined_step2'.format(sa_key), save_params_every=10, save_params=True)
...
#                 # define the model
    ...
    StateLogger = PickledJsonLog(output_prefix=DataDir + 'log_vit_sampler_{}_refined_flip_step2'.format(sa_key), save_params_every=10, save_params=True)
